@include('layouts.header')
                        ...
                        <div class="row jo-main mb-5 pb-lg-5 align-items-center">
                            ...
                            <div class="col-12 col-lg-5 ml-auto">
                                <p class="mb-4 text-center">
                                    Зарегистрируйся сейчас и получи 30% скидку! Предложение ограничено!
                                </p>

                                <form action="https://jury.online/api/signup" method="post">
    ...
    <input class="form-control text-center text-lg-left" id="email" name="email" placeholder="Эл. почта" required type="email" value="">
    ...
    <input class="form-control text-center text-lg-left" id="password" name="password" placeholder="Пароль" required type="password" value="">
...
<!-- Mirrored from jury.online/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 21 Oct 2017 17:00:47 GMT -->
</html>
